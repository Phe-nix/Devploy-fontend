<script lang="ts">
	...
	let portDB = $state(data.databaseInfo.port);

	let startDB = () => {
		const req = axios.post(
			`${PUBLIC_BASE_API}/database/${page.params.databaseId}/start`,
			{},
			{
				headers: {
		...
		toast.promise(req, {
			...
			success: () => {
				invalidateAll();
				return data.databaseInfo.name + ' has been Started';
			},
			error: (e: any) => {
				return e.message;
			}
	...
	let stopDB = () => {
		...
		toast.promise(req, {
			...
			success: () => {
				invalidateAll();
				return data.databaseInfo.name + ' has been Stoped';
			},
			error: (e: any) => {
				return e.message;
			}
	...
	<div class="grid grid-cols-2 gap-4">
		...
		<div class="flex flex-col gap-2">
			...
			<div class="flex items-center gap-2">
				...
				<p class="font-semibold">{data.databaseInfo.username}</p>
			</div>
		</div>
		<div class="flex flex-col gap-2">
