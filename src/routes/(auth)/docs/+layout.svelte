...
<Sidebar.Provider class="">
	<DocsSidebar />
	<Sidebar.Inset>
		<div class="fixed w-full bg-card">
			<header class="flex h-16 shrink-0 items-center gap-2 border-b px-4">
				...
				<Breadcrumb.Root>
					<Breadcrumb.List>
						...
						<Breadcrumb.Item>
							<Breadcrumb.Page>
								<p class="capitalize">{capitalize(page.url.pathname.split('/').pop() || '')}</p>
							</Breadcrumb.Page>
						</Breadcrumb.Item>
					</Breadcrumb.List>
				</Breadcrumb.Root>
		...
		<div class="flex flex-1 flex-col gap-4 md:px-32 px-12 py-8 mt-16">
